...
""")
  ...
  def output_sample(self):
    ...
    itms_DER_REPORT_SUBTABLE='''
    ID, Report_Search_ID, Origin_Report_Search_ID, Time_Year, Quarter, Forecast_Income, Forecast_Profit,Forecast_Income_Share, 
    Forecast_Return_Cash_Share, Forecast_Return_Capital_Share, Forecast_Return,  R_Tar1,R_Tar2, R_Tar3, R_Tar4, R_Tar5, R_Tar_Date1, R_Tar_Date2, Forecast_Income_0, 
    Forecast_Profit_0, Profit_Flag, EntryDate, EntryTime, TMStamp
    '''
